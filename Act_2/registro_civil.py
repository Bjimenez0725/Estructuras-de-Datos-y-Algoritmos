...
def corregir_estado_civil(registro_mujeres, raiz_varones, df_casamientos):
    ...
    def abb_a_lista(nodo, resultado):
        if nodo:
            ...
            resultado.append({'DNI': nodo.DNI, 'Apellido': nodo.Apellido, 'EstadoCivil': nodo.EstadoCivil})
    ...
    print(pd.DataFrame(varones_final)[['DNI', 'Apellido', 'EstadoCivil']])
    ...
    print(df_mujeres_final[['DNI', 'Apellido', 'EstadoCivil']])
